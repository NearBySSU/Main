...
public class SinglePostPageActivity extends AppCompatActivity {
    ...
    private String profileImageUrl; // userid로 찾아줌
    private String nickName; // userid로 찾아줌
    private ImageButton mapImageButton; // 걍 버튼
    private RecyclerView imageRecyclerView; // 배열일단 받고
    private String date;
    private String bigLocation;
    private String smallLocation;
    private RecyclerView tagRecyclerView; // 배열일단받고
    private String text;
    private ImageButton likeBtnImageButton; //  아님
    private ImageButton commentBtnImageButton; // 아님
                ...
                .addOnCompleteListener(task -> {
                    if (task.isSuccessful()) {
                        ...
                        if (document != null) {
                            ...
                            Log.d("SinglePage", profileImageUrl != null ? profileImageUrl : "text is null");
                            Log.d("SinglePage", nickName != null ? nickName : "text is null");
                        }
                    }
                    else {
                        Log.d("SinglePost", "get failed with ", task.getException());
